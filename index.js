...
if (!fs.existsSync('./Hans_Session')) {
    ...
    console.log(chalk.green('📁 Created Hans_Session directory'));
}
...
async function downloadSessionFromMega() {
    return new Promise((resolve, reject) => {
        ...
        console.log(chalk.blue('📥 Downloading Hans_Session from mega.nz...'));
        try {
            ...
            filer.download((err, data) => {
                ...
                fs.writeFile('./Hans_Session/creds.json', data, (writeErr) => {
                    ...
                    console.log(chalk.green('✅ Hans_Session downloaded successfully'));
                    resolve(true);
                });
            });
        } catch (error) {
            ...
            if (connection === 'close') {
                ...
                if (statusCode === DisconnectReason.loggedOut || statusCode === 401) {
                    try {
                        ...
                        console.log(chalk.yellow('🗑️  Hans_Session folder deleted.'));
...
console.log(chalk.blue('🚀 Starting VORTEX-XMD Bot...'));
